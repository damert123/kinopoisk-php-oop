            ...
            <div class="card mb-3 mt-3 one-movie__item">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <?php if ($auth->check()) { ?>
                            <form action="/review/add" method="post" class="m-3 w-100">
                                <input type="hidden" value="<?php echo $movie->id() ?>" name="id">
                                <select class="form-select <?php echo $session->has('rating') ? 'is-invalid' : '' ?>"
                                        name="rating"
                                ...
                                <div class="form-floating mt-2">
                                    <textarea class="form-control <?php echo $session->has('review') ? 'is-invalid' : '' ?>"
                                              name="review"
                        ...
                        <?php } else { ?>
                            <div class="alert alert-info m-3 text-center w-100">
                                Чтобы оставить отзыв, <a href="/login">авторизируйтесь</a>
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text"><small class="text-body-secondary"><?php echo $movie->createdAt() ?></small></p>
                            <h4>Отзывы</h4>
